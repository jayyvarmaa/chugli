...
export function createPasswordResetEmailTemplate(verificationCode) {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #ff6b6b, #ee5a6f); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <div style="background-color: #f0f4f8; padding: 25px; border-radius: 10px; margin: 25px 0; text-align: center; border: 2px solid #ff6b6b;">
        <p style="margin: 0 0 15px 0; color: #666; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Verification Code</p>
        <p style="margin: 0; font-size: 48px; font-weight: bold; color: #ff6b6b; letter-spacing: 8px; font-family: 'Courier New', monospace;">${verificationCode}</p>
        <p style="margin: 15px 0 0 0; color: #999; font-size: 12px;">This code expires in 10 minutes</p>
      </div>
      
      <div style="background-color: #fff3cd; padding: 15px; border-radius: 8px; border-left: 4px solid #ff6b6b; margin: 20px 0;">
        <p style="margin: 0; color: #856404; font-size: 13px;">
          <strong>⚠️ Security Note:</strong> If you didn't request a password reset, please ignore this email or contact support immediately.
        </p>
      </div>
      
      <p style="margin-top: 25px; margin-bottom: 5px;">For security reasons:</p>
      ...
      <p style="margin-top: 25px; margin-bottom: 0;">Best regards,<br>The Chugli Security Team</p>
    </div>
    
    <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
      <p>© 2025 Chugli. All rights reserved.</p>
    </div>
  </body>
  </html>
  `;
